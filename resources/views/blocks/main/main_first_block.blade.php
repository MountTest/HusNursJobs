<div class="container">
    <div class="row">
        <div class="col-5" style="padding-top: 10%">
            <h1 class="" style="margin-top: 0;margin-bottom: 0;">Create, your way</h1><br>
            ...
            <a href="#" class="get-started"  style="padding: 15px;color: white;background-color: #2d7ff9;border-radius: 10px;" >Get Started </a>
        </div>
        <div class="col-6">
