<section class="pt-5">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-12">
                <h2 class="row justify-content-center">Features</h2>
            </div>
            <div class="col-12 ">
                <p class="row justify-content-center " style="text-align: center!important;">Some of the features and advantages that we provide for those of
                    you who <br> store data in this Data
                    Warehouse.</p>
            </div>
        </div>
        <div class="row justify-content-center align-items-center">
